...
ThriftClientConfig = _reflection.GeneratedProtocolMessageType('ThriftClientConfig', (_message.Message,), dict(
...
_THRIFTCLIENTCONFIG_SERVICECONFIGSENTRY.has_options = True
_THRIFTCLIENTCONFIG_SERVICECONFIGSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
