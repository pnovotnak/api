...
type VirtualService struct {
	...
	// An ordered list of route rules for Thrift traffic. Thrift routes will be
	// applied to platform service ports named 'thrift-*', gateway ports with
	// protocol Thrift and service entry ports using Thrift. The first rule
	// matching an incoming request is used.
	Thrift []*ThriftRoute `protobuf:"bytes,7,rep,name=thrift,proto3" json:"thrift,omitempty"`
...
// Describes match conditions and actions for routing Thrift traffic.
...
// ThriftMatchRequest specifies a set of criterion to be met in order for the
// rule to be applied to the Thrift request. For example, the following
...
type ThriftMatchRequest struct {
	// Method to match
	MethodName           *StringMatch `protobuf:"bytes,2,opt,name=method_name,json=methodName,proto3" json:"method_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *ThriftMatchRequest) GetMethodName() *StringMatch {
	if m != nil {
		return m.MethodName
	}
	return nil
...
var fileDescriptor_e85a9a4fa9c17a22 = []byte{
	...
	,
}
